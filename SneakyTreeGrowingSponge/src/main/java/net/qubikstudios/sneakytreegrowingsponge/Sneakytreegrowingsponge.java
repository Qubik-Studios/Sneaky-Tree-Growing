package net.qubikstudios.sneakytreegrowingsponge;
 ...
 */
@Plugin("sneakytreegrowingsponge")
public class Sneakytreegrowingsponge {

    private final PluginContainer container;
    private final Logger logger;

    @Inject
    Sneakytreegrowingsponge(final PluginContainer container, final Logger logger) {
    ...
    public void onConstructPlugin(final ConstructPluginEvent event) {
        ...
        this.logger.info("Constructing sneakytreegrowingsponge");
    }
    ...
    public void onRegisterCommands(final RegisterCommandEvent<Command.Parameterized> event) {
        ...
        event.register(this.container, Command.builder()
                ...
                .permission("sneakytreegrowingsponge.command.greet")
                .executor(ctx -> {
